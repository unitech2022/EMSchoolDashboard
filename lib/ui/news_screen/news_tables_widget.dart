...
class NewsTablesWidget extends StatelessWidget {
  final List<NewsModel> list;
  final int type;
  const NewsTablesWidget(
...
DataRow recentUserDataRow(
    NewsModel model, BuildContext context, int type) {
  return DataRow(
    cells: [
      DataCell(
        Padding(
        ...
        Row(
          children: [
            TextButton(
              ...
              onPressed: () {
                context.navigatePush(AddNewsScreen(
                  isUpdate: true,
                  model: model,
                ));
              },
                ...
                dailogDeleteData(
                    ...
                    onDelete: () {
                      ...
                      NewsCubit.get(context)
                          .deleteNews(context: context, id: model.id);
                    },
                    value: "");
              },
              // Delete
